...
GENERIC_PARAMS = ParameterCollection(
    ...
    Parameter('roi_xlow', int, 0, name='ROI lower x limit',
              tooltip=TOOLTIPS['roi_xlow'], unit='px'),
    Parameter('roi_xhigh', int, None, name='ROI upper x limit',
              tooltip=TOOLTIPS['roi_xhigh'], unit='px', allow_None=True),
    Parameter('roi_ylow', int, 0, name='ROI lower y limit',
              tooltip=TOOLTIPS['roi_ylow'], unit='px'),
    Parameter('roi_yhigh', int, None, name='ROI upper y limit',
              tooltip=TOOLTIPS['roi_yhigh'], unit='px', allow_None=True),
    Parameter('use_thresholds', int, 0, name='Use Thresholds',
              choices=[True, False], tooltip=TOOLTIPS['use_thresholds']),
    Parameter('threshold_low', float, None, name='Lower threshold',
              tooltip=TOOLTIPS['threshold_low'], allow_None=True),
    Parameter('threshold_high', float, None, name='Upper threshold',
    ...
    Parameter('raw_image_shape', tuple, (0, 0), name='Raw image shape',
              tooltip=TOOLTIPS['raw_image_shape'], unit='px'),
    ...
    Parameter('delta_1', float, 1, name='Step width in direction 1',
    ...
    Parameter('delta_2', float, 1, name='Step width in direction 2',
    ...
    Parameter('delta_3', float, 1, name='Step width in direction 3',
    ...
    Parameter('delta_4', float, 1, name='Step width in direction 4',
