...
"""
Module with the ScanSettingsYamlIo class which is used to import
ScanSettings metadata from a YAML file.
"""
...
__all__ = ['ScanSettingsIoYaml']


import yaml

from pydidas.constants import YAML_EXTENSIONS
from .scan_settings_io_base import ScanSettingsIoBase
from .scan_settings import ScanSettings

SCAN = ScanSettings()


class ScanSettingsIoYaml(ScanSettingsIoBase):
    """
    ...
    def import_from_file(cls, filename):
        """
        Restore the ScanSettings from a YAML file.
