...
from .builders.directory_spy_frame_builder import (
...
class DirectorySpyFrame(DirectorySpyFrameBuilder):
    ...
    def __update_bg_widget_visibility(self):
        ...
        _hdf5_bgfile = (os.path.splitext(self.get_param_value('bg_file'))[1]
                        in HDF5_EXTENSIONS)
        self.toggle_param_widget_visibility('bg_hdf5_key',
                                            _vis and _hdf5_bgfile)
        self.toggle_param_widget_visibility('bg_hdf5_frame',
                                            _vis and _hdf5_bgfile)
    ...
    def _run_app(self):
        ...
        self._runner = AppRunner(self._app, n_workers=1,
                                 processor=app_processor_without_tasks)
    ...
    def __update_plot(self):
        ...
        self._widgets['plot'].addImage(self._app.image, replace=True,
                                       copy=False)
