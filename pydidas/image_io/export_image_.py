...
"""
The export_image module includes the export_image function which can be
used to export data in any supported image format.
"""
...
# TODO : Change to registry-based IO
