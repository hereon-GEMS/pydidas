...
"""
Module with CoordinateTransformMixin to add coordinate transform functionality to other
silx plot widgets.
"""
...
__all__ = ["CoordinateTransformMixin"]
...
class CoordinateTransformMixin:
    """
    Mix-in class to add coordinate transform functionality to silx plot widgets.

    The main class must be a silx.gui.plot.PlotWindow or subclass to have access to
    its backend functionality.
    """
    def __init__(self, **kwargs):
        self._beam_center = (0, 0, 0.1)
        self._pixelsize = (100e-6, 100e-6)
        assert hasattr(self, "_backend")
