...
class TripleLorentzian(Lorentzian):
    ...
    num_peaks = 3
    param_bounds_low: ClassVar[list[float]] = Lorentzian.param_bounds_low * num_peaks
    param_bounds_high: ClassVar[list[float]] = Lorentzian.param_bounds_high * num_peaks
