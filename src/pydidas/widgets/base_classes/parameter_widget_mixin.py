...
"""
Module with the ParameterWidgetMixIn class used to edit Parameters through widgets.
"""
...
if TYPE_CHECKING:
    ...
    from pydidas.widgets.param_io.parameter_widget import ParameterWidget
else:
    ParameterWidget = LazyObject(
        "pydidas.widgets.param_io.parameter_widget", "ParameterWidget"
    )
