...
class PydidasScrollArea(QScrollArea):
    """
    Convenience class to simplify the setup of a QScrollArea which
    automatically resizes in width to the sizeHint of the contained widget.
