...
"""
The pydidas_widget_mixin module includes the PydidasWidgetMixIn
class to add additional functionality implemented in PydidasQApplication.
"""
...
class PydidasWidgetMixIn:
    ...
    LAYOUT_VERTICAL_SPACING: ClassVar[int] = 0
    LAYOUT_HORIZONTAL_SPACING: ClassVar[int] = 0
    LAYOUT_TOP_BOTTOM_MARGIN: ClassVar[int] = 0
    LAYOUT_LEFT_RIGHT_MARGIN: ClassVar[int] = 0
    LAYOUT_ALIGNMENT: ClassVar[Qt.Alignment] = ALIGN_TOP_LEFT
