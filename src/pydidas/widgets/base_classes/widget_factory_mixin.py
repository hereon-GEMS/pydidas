...
"""
Module with the WidgetFactoryMixIn class which can be inherited from to
add convenience widget creation methods to other classes.

Note that for consistency, the WidgetFactoryMixIn class is located
in the base_classes subpackage, even though it relies on the
base_reimplementations subpackage for the actual widget creation.
To avoid circular imports, the widgets from the base_reimplementations
subpackage are imported lazily using the LazyObject class.
"""
...
from pydidas.widgets.base_classes.empty_widget import EmptyWidget
...
if TYPE_CHECKING:
    ...
    from pydidas.widgets.factory.pydidas_table import PydidasTable
    ...
    PydidasCheckBox = LazyObject(
        "pydidas.widgets.base_reimplementations.pydidas_checkbox", "PydidasCheckBox"
    )
    PydidasComboBox = LazyObject(
        "pydidas.widgets.base_reimplementations.pydidas_combobox", "PydidasComboBox"
    )
    PydidasLabel = LazyObject(
        "pydidas.widgets.base_reimplementations.pydidas_label", "PydidasLabel"
    )
    PydidasLineEdit = LazyObject(
        "pydidas.widgets.base_reimplementations.pydidas_lineedit", "PydidasLineEdit"
    )
    PydidasListWidget = LazyObject(
        "pydidas.widgets.base_reimplementations.pydidas_list_widget",
        "PydidasListWidget",
    )
    PydidasPushButton = LazyObject(
        "pydidas.widgets.base_reimplementations.pydidas_pushbutton",
        "PydidasPushButton",
    )
    PydidasSvgWidget = LazyObject(
        "pydidas.widgets.base_reimplementations.pydidas_svgwidget", "PydidasSvgWidget"
    )
    PydidasTable = LazyObject(
        "pydidas.widgets.base_reimplementations.pydidas_table", "PydidasTable"
    )
    RadioButtonGroup = LazyObject(
        "pydidas.widgets.base_reimplementations.radio_button_group",
        "RadioButtonGroup",
    )
    SquareButton = LazyObject(
        "pydidas.widgets.base_reimplementations.square_button", "SquareButton"
    )
...
class WidgetFactoryMixIn:
    ...
    The WidgetFactoryMixIn class includes methods for easy adding of widgets
    ...
    def create_spacer(self, ref: str | None, **kwargs: Any) -> None:
        """
    ...
    def create_label(self, ref: str | None, text: str, **kwargs: Any) -> None:
        """
    ...
    def create_line(self, ref: str | None, **kwargs: Any) -> None:
        """
    ...
    def create_list_widget(self, ref: str | None, **kwargs: Any) -> None:
        """
    ...
    def create_vertical_line(self, ref: str | None, **kwargs: Any) -> None:
        """
        ...
        **kwargs : Any
            ...
            implementation are valid kwargs.
        """
        kwargs["frameShape"] = kwargs.get("frameShape", QtWidgets.QFrame.VLine)
        kwargs["frameShadow"] = kwargs.get("frameShadow", QtWidgets.QFrame.Sunken)
        kwargs["lineWidth"] = kwargs.get("lineWidth", 2)
        kwargs["fixedWidth"] = kwargs.get("fixedWidth", 3)
        self.create_any_widget(ref, QtWidgets.QFrame, **kwargs)

    def create_lineedit(self, ref: str | None, **kwargs: Any) -> None:
        """
    ...
    def create_button(self, ref: str | None, text: str, **kwargs: Any) -> None:
        """
    ...
    def create_square_button(self, ref: str | None, **kwargs: Any) -> None:
        """
    ...
    def create_spin_box(self, ref: str | None, **kwargs: Any) -> None:
        """
    ...
    def create_double_spin_box(self, ref: str | None, **kwargs: Any) -> None:
        """
    ...
    def create_progress_bar(self, ref: str | None, **kwargs: Any) -> None:
        """
    ...
    def create_check_box(self, ref: str | None, text: str, **kwargs: Any) -> None:
        """
        ...
        **kwargs : Any
            ...
            are valid kwargs. In addition, the 'gridPos' keyword can be used
            to specify the QCheckBox's position in its parent's layout.
    ...
    def create_combo_box(self, ref: str | None, **kwargs: Any) -> None:
        """
    ...
    def create_empty_widget(self, ref: str | None, **kwargs: Any) -> None:
        """
    ...
    def create_svg_widget(
        self, ref: str | None, svg_path: str | Path, **kwargs: Any
    ) -> None:
        """
        ...
        **kwargs : Any
            ...
            method or from pydidas' WidgetFactoryMixIn class are valid.
        """
        self.create_any_widget(ref, PydidasSvgWidget, svg_path, **kwargs)

    def create_table(self, ref: str | None, **kwargs: Any) -> None:
        """
        ...
        **kwargs : Any
        ...
        """
        self.create_any_widget(ref, PydidasTable, **kwargs)
    ...
    def add_any_widget(
        self, ref: str | None, widget_instance: QWidget, **kwargs: Any
    ) -> None:
        """
        ...
        **kwargs : Any
        ...
        if _parent is not None:
            _layout_args = get_widget_layout_args(_parent, **kwargs)  # type: ignore[arg-type]
