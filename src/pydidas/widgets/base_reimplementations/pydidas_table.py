...
"""
Module with the PydidasTable class which is a table which scales in size with the font.
"""
...
class PydidasTable(PydidasWidgetMixIn, QtWidgets.QTableWidget):
    """A QTableWidget with automatic font scaling."""
