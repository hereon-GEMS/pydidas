...
"""
Module with the ReadOnlyTextEdit which is a subclassed QTextEdit and can
...
class ReadOnlyTextEdit(PydidasWidgetMixIn, QtWidgets.QTextEdit):
    """
    A QTextEdit widget with advanced text display and formatting support.

    The ReadOnlyTextEdit is a subclass of QTextEdit and is used to
    ...
    **kwargs : Any
    ...
    def __init__(self, parent: QtWidgets.QWidget | None = None, **kwargs: Any):
        """
        Initialize the ReadOnlyTextEdit.
