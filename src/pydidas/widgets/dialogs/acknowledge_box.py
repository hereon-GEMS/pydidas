...
"""
Module with AcknowledgeBox class for handling dialogs with an 'acknowledge' tick
...
from pydidas.widgets.base_classes import PydidasScrollArea, WidgetFactoryMixIn
from pydidas_qtcore.pydidas_qapp import PydidasQApplication


class AcknowledgeBox(QtWidgets.QDialog, WidgetFactoryMixIn):
    """
