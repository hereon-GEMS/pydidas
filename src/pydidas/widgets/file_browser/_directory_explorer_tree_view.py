...
"""
Module with the _DirectoryExplorerTreeView widget, which is an implementation of a
...
__all__ = ["_DirectoryExplorerTreeView"]
...
class _DirectoryExplorerTreeView(QtWidgets.QTreeView):
    """
    The _DirectoryExplorerTreeView is an implementation of a QTreeView widget with a
    ...
    **kwargs : Any
    ...
    def setModel(self, model: QtCore.QAbstractItemModel) -> None:
        ...
        if not isinstance(
            ...
            raise TypeError(
                "The _DirectoryExplorerTreeView only supports QFileSystemModel or "
