...
"""
Module with IntegrationRoiParamContainer class to display integration
region Parameters.
"""
...
__all__ = ["IntegrationRoiParamContainer"]
...
class IntegrationRoiParamContainer(WidgetWithParameters):
    """
