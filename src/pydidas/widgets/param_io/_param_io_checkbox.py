...
"""
Module with the _ParamIoCheckBox class used to edit boolean Parameters.
...
from pydidas.widgets.base_reimplementations import PydidasCheckBox
from pydidas.widgets.param_io.base_param_io_widget import BaseParamIoMixIn


class _ParamIoCheckBox(BaseParamIoMixIn, PydidasCheckBox):
