...
"""
Module with the _ParamIoLineEdit class used to edit free-text Parameters.
...
from pydidas.widgets.base_reimplementations import PydidasLineEdit
from pydidas.widgets.param_io.base_param_io_widget import (
    BaseParamIoMixIn,
)


class _ParamIoLineEdit(BaseParamIoMixIn, PydidasLineEdit):
    """
    ...
    **kwargs : Any
    ...
    def update_display_value(self, value: Any) -> None:
        ...
        This method is defined in the BaseParamIoMixIn and is called
