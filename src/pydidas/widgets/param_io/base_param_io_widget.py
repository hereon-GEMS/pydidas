...
"""
Module with the BaseParamIoMixIn base class which all widgets for editing
...
__all__ = ["BaseParamIo", "BaseParamIoMixIn"]
...
class BaseParamIoMixIn:
    ...
    def set_unique_ref_name(self, name: str) -> None:
        ...
        if hasattr(self, "_io_dialog_config"):
            ...
            if "reference" in self._io_dialog_config:
                del self._io_dialog_config["reference"]
    ...
    def update_choices(
        ...
        """
        Update the choices of the BaseParamIo in place.
...
class BaseParamIo(BaseParamIoMixIn, QtWidgets.QWidget):
    def __init__(
