...
from pydidas.core.fitting.double_lorentzian import DoubleLorentzian


class TestDoubleLorentzian(unittest.TestCase):
    def setUp(self):
    ...
    def test_profile__no_bg(self):
        ...
        _c = (0, 1, 1, 0, 3, 3)
        _profile = DoubleLorentzian.profile(_c, _x)
    ...
    def test_guess_peak_start_params__simple(self):
        _params = DoubleLorentzian.guess_fit_start_params(self._x, self._data)
    ...
    def test_guess_peak_start_params__bounds_for_peak1(self):
        _bounds = (
            DoubleLorentzian.param_bounds_low[:],
            DoubleLorentzian.param_bounds_high[:],
        )
        _bounds[0][2] = self._x[500]
        _bounds[1][2] = self._x[530]
        _params = DoubleLorentzian.guess_fit_start_params(
