...
class TestRoiController(unittest.TestCase):
    ...
    def create_RoiController(self, _roi=None):
        obj = RoiController()
        if _roi is not None:
            obj._RoiController__roi_key = copy.copy(_roi)
        obj._RoiController__check_types_roi_key()
        return obj
    ...
    def test_modulate_roi_keys__all_positive(self):
        ...
        _shape = (12, 12)
        obj = RoiController()
        obj._RoiController__roi = _roi
        obj._RoiController__input_shape = _shape
        obj._RoiController__modulate_roi_keys()
    ...
    def test_check_types_roi_key__w_None(self):
        obj = RoiController()
        obj._RoiController__roi_key = None
        obj._RoiController__check_types_roi_key()
        self.assertEqual(obj._RoiController__roi_key, None)

    def test_check_types_roi_key__w_list(self):
        _list = ['Test', 'Test2']
        obj = RoiController()
        obj._RoiController__roi_key = _list
        obj._RoiController__check_types_roi_key()
        self.assertEqual(obj._RoiController__roi_key, _list)

    def test_check_types_roi_key__w_str(self):
        _str = 'Test, Test2'
        obj = RoiController()
        obj._RoiController__roi_key = _str
        obj._RoiController__check_types_roi_key()
        self.assertIsInstance(obj._RoiController__roi_key, list)

    def test_check_types_roi_key__w_tuple(self):
        _roi = ('Test', 'Test2')
        obj = RoiController()
        obj._RoiController__roi_key = _roi
        obj._RoiController__check_types_roi_key()
        self.assertEqual(obj._RoiController__roi_key, list(_roi))
    ...
    def test_convert_str_roi_key_to_list__simple(self):
        ...
        obj = RoiController()
        obj._RoiController__roi_key = _roi
        obj._RoiController__convert_str_roi_key()
        self.assertEqual(obj._RoiController__roi_key, _list)
    ...
    def test_check_types_roi_key_entries(self):
        obj = RoiController()
        obj._RoiController__roi_key = [12, slice(0, 2)]
        obj._RoiController__check_types_roi_key_entries

    def test_check_types_roi_key_entries__w_float(self):
        obj = self.create_RoiController()
        obj._RoiController__roi_key = [12, slice(0, 15), 12.3]
        with self.assertRaises(ValueError):
            obj._RoiController__check_types_roi_key_entries()
    ...
    def test_check_and_convert_str_roi_key_entries__int(self):
        ...
        obj._RoiController__convert_str_roi_key_entries()
        self.assertEqual(obj._RoiController__roi_key, _roi)
    ...
    def test_check_and_convert_str_roi_key_entries__2slices_wo_steps(self):
        ...
        obj = self.create_RoiController(_strroi)
        obj._RoiController__convert_str_roi_key_entries()
        self.assertEqual(obj._RoiController__roi_key,
                          [slice(1, 5), slice(0, 2)])
    ...
    def test_check_length_of_roi_key_entries(self):
        ...
        obj._RoiController__check_length_of_roi_key_entries()
    ...
    def test_convert_roi_key_to_slice_objects__4_ints(self):
        _roi = [1, 5, 0, 7]
        obj = self.create_RoiController(_roi)
        obj._RoiController__convert_roi_key_to_slice_objects()
        self.assertEqual(obj._RoiController__roi,
    ...
    def test_convert_roi_key_to_slice_objects__2_slices(self):
        ...
        obj = self.create_RoiController(_roi)
        obj._RoiController__convert_roi_key_to_slice_objects()
        self.assertEqual(obj._RoiController__roi, (_roi[0], _roi[1]))
    ...
    def test_convert_roi_key_to_slice_objects__wrong_trailing_order(self):
        obj = RoiController()
        obj._RoiController__roi_key = [slice(0, 5), 1, slice(0, 5)]
        with self.assertRaises(ValueError):
            obj._RoiController__convert_roi_key_to_slice_objects()
