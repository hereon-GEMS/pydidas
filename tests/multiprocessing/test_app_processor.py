...
class _ProcThread(threading.Thread):
    ...
    def __init__(self, input_queue, output_queue, app, app_params, app_config):
        super().__init__()
    ...
    def run(self):
       app_processor(self.input_queue, self.output_queue, self.app,
                     self.app_params, self.app_config)
...
class Test_app_processor(unittest.TestCase):
    ...
    def test_run_plain(self):
        ...
        app_processor(self.input_queue, self.output_queue,
