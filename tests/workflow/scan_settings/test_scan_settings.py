...
from pydidas.workflow import ScanSettings
from pydidas.workflow.scan_settings.scan_settings import _ScanSettings
...
class TestScanSettings(unittest.TestCase):
    ...
    def test_init(self):
        SCAN = _ScanSettings()
        self.assertIsInstance(SCAN, _ScanSettings)
